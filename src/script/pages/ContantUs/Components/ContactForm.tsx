...
export default function ContactForm() {
    return (
        <div>
            <div>
                <h2>Contact Form</h2>
                <p>For your convenience, you can also use the contact form below to send us a message. Please provide as much detail as possible, and we'll get back to you as soon as we can.</p>
